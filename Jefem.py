...
class Jugador(pygame.sprite.Sprite):
    ...
    def __init__(self, tipo):
        ...
        if self.tipoj==0:
            ...
            self.imaged=pygame.image.load("imagenes/fteddy.png")
            self.imaged=pygame.transform.scale(self.imaged,(48,48))
            self.imageu=pygame.image.load("imagenes/bteddy.png")
            self.imageu=pygame.transform.scale(self.imageu,(48,48))
            self.image=self.imagel
            self.rect=self.image.get_rect()
            self.vel=8
        ...
        def __init__(self, posx, posy,tipo, direc, dan):
                ...
                if self.tipo == 0:
                    ...
                    if self.direccion == 1:
                        ...
                        self.rect.y = posy - 50
                    if self.direccion ==0:
                        self.image = pygame.image.load("imagenes/fshockwavel.png")
                        self.rect  = self.image.get_rect()
                        self.rect.x = posx
                        self.rect.y = posy - 50
                    if self.direccion ==2:
                        self.image = pygame.image.load("imagenes/fshockwaveu.png")
                        self.rect  = self.image.get_rect()
                        self.rect.x = posx - 50
                        self.rect.y = posy
                    if self.direccion ==3:
                        self.image = pygame.image.load("imagenes/fshockwaved.png")
                        self.rect  = self.image.get_rect()
                        self.rect.x = posx - 50
                        self.rect.y = posy
                if self.tipo ==1:
                    ...
                    if self.direccion ==1:
                        ...
                        self.rect.y = posy
                    if self.direccion ==0:
                        self.image = pygame.image.load("imagenes/fLongshotl.png")
                        self.rect  = self.image.get_rect()
                        self.rect.x = posx
                        self.rect.y = posy
                    if self.direccion ==2:
                        self.image = pygame.image.load("imagenes/fLongshotu.png")
                        self.rect  = self.image.get_rect()
                        self.rect.x = posx
                        self.rect.y = posy
                    if self.direccion ==3:
                        self.image = pygame.image.load("imagenes/fLongshotd.png")
                        self.rect  = self.image.get_rect()
                        self.rect.x = posx
                        self.rect.y = posy
                if self.tipo ==2:
